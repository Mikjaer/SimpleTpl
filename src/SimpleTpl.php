...
{
    private $stack;
    private String $filename; // Set by fetch and render methods
    private array $linenumber;
    private Int $eip; // Tokken pointer
    
    private bool $debug = false;
    
    private String $variable_name = '[0-9a-zA-Z_\$]+';
    ...
    /**
    * Renders template from string and returns result
    */
     ...
     */
    public function debug(bool $debugEnable = true):void
    {
     ...
     */
    public function append(String $key, String|Array $value):void
    {
        $this->stack[$key][] = $value;
    }

    /**
     * Merge an array with $value
     */
    ...
    /**
     * Assign a $value to $key on stack
     */
    ...
    /**
     * Renders template from file and returns result
     */
    public function fetch(String $templateFile):String
    {
        $this->filename = $templateFile;
        return $this->render(file_get_contents($templateFile));
    }

    /** 
     * Renders template and output results to stdout
     */
    public function display(String $templateFile):void
    {
        print $this->fetch($templateFile);
    }
}
?>
